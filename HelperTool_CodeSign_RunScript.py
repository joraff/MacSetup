...
'''
helper_name_override = 'edu.tamu.liberalarts.LAITMacSetupHelper';

'''Set these to the appropriate path'''
helper_info = 'LAITMacSetupHelper/LAITMacSetupHelper-Info.plist'
helper_launchd = 'LAITMacSetupHelper/LAITMacSetupHelper-Launchd.plist'
...
#    app_info_plist = os.getenv('INFOPLIST_FILE')
    app_info_plist = 'LAITMacSetup/Info.plist'
...
def main():
    ...
    checkVar(app_name,"PRODUCT_NAME -- i.e. App Name")
